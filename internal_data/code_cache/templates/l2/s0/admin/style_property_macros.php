...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['customizationState'] == 'custom') {
		$__compilerTemp1 .= '
							<span class="cssPropertyRevert" data-xf-init="tooltip" title="' . $__templater->filter('Отменить изменения', array(array('for_attr', array()),), true) . '">
								' . $__templater->callMacro(null, 'revert_code', array(
			'submitName' => $__vars['submitName'],
			'property' => $__vars['property'],
			'label' => 'Отменить изменённое значение',
			'container' => '< .block-row',
		), $__vars) . '
							</span>
						';
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('text', ))) {
		...
		array(
			...
			'label' => '
											' . 'Не использовать дополнительное оформление текста' . '
										',
			'_type' => 'option',
		))) . '
								</td>
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('border', )) OR $__templater->method($__vars['property'], 'isValidCssComponent', array('border_radius', ))) {
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Сверху' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Вправо' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Снизу' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Влево' . '</td>
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('extra', ))) {
		$__finalCompiled .= '
						<li class="cssPropertyExtra">
							...
							<table class="cssPropertySet">
								<tr class="cssPropertySet-headerRow">
									<th>' . 'Дополнительный CSS/LESS-код' . '</th>
								</tr>
								<tr>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['state'] == 'custom') {
		$__compilerTemp1 .= '
				...
				<span data-xf-init="tooltip" title="' . $__templater->filter('Значение этого свойства было изменено в данном стиле', array(array('for_attr', array()),), true) . '">
					';
		if ($__vars['checkbox']) {
			$__compilerTemp1 .= '
						' . $__templater->callMacro(null, 'revert_code', array(
