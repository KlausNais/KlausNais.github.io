...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'hint' => 'Если выбрано, то адрес электронной почты пользователя будет преобразован в MD5-хэш перед отправкой. Это уменьшает количество проверок, которые возможны, включая проверки чёрного списка.',
		'_type' => 'option',
	)))),
		'_type' => 'option',
	),
