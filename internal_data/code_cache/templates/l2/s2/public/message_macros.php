<?php
// FROM HASH: 77d58e05b7b9e4372ad4749d4c77d263
return array(
	...
	if ($__vars['user']['user_id']) {
		...
		if ($__vars['extras']['website'] AND $__vars['user']['Profile']['website']) {
			$__compilerTemp1 .= '
						<dl class="pairs pairs--justified">
							<dt>' . 'Веб-сайт' . '</dt>
							<dd><a href="' . $__templater->escape($__vars['user']['Profile']['website']) . '" rel="nofollow" target="_blank">' . $__templater->filter($__vars['user']['Profile']['website'], array(array('url_display', array('host', 'Посетить сайт', )),), true) . '</a></dd>
						</dl>
					';
		}
		$__compilerTemp1 .= '
