<?php
// FROM HASH: eda3057b2150cec20d296606d5a25788
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__vars['cssUrls'] = $__templater->func('array_merge', array($__vars['cssUrls'], array('public:mijafont.css', ), ), false);
	$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
		...
		jQuery.extend(XF.phrases, {
			...
			pull_down_to_refresh: "' . $__templater->filter('pull_down_to_refresh', array(array('escape', array('js', )),), true) . '",
			release_to_refresh: "' . $__templater->filter('release_to_refresh', array(array('escape', array('js', )),), true) . '",
			refreshing: "' . $__templater->filter('refreshing...', array(array('escape', array('js', )),), true) . '"
		});
	</script>
