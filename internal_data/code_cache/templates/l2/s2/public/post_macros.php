<?php
// FROM HASH: db95cdff5e1f23c4df31e25ad2f609b8
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['showUser']) {
		...
		$__finalCompiled .= '
				<li class="u-concealed message-attribution-user--top">' . 'От ' . $__templater->escape($__vars['username']) . '' . '</li>
			';
	}
	$__finalCompiled .= '
	...
	$__finalCompiled .= '
			<li>
				<a href="' . $__templater->func('link', array('threads/post', $__vars['thread'], array('post_id' => $__vars['post']['post_id'], ), ), true) . '"
					...
					aria-label="' . $__templater->filter('Поделиться', array(array('for_attr', array()),), true) . '"
					rel="nofollow">
	...
	if ($__templater->method($__vars['thread'], 'canReply', array()) OR $__templater->method($__vars['thread'], 'canReplyPreReg', array())) {
		...
		$__compilerTemp1 .= '
				...
				<a href="' . $__templater->escape($__vars['quoteLink']) . '"
					...
					rel="nofollow"
					data-xf-click="quote"
					data-quote-href="' . $__templater->func('link', array('posts/quote', $__vars['post'], ), true) . '">' . 'Ответить' . '</a>
			';
	}
	$__compilerTemp1 .= '
		';
	...
	if ($__vars['post']['edit_count'] AND $__templater->method($__vars['post'], 'canViewHistory', array())) {
		$__compilerTemp2 .= '
				<a href="' . $__templater->func('link', array('posts/history', $__vars['post'], ), true) . '"
					...
					data-menu-closer="true">' . 'История' . '</a>
