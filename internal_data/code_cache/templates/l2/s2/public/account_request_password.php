	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				' . 'На данный момент Ваша учётная запись не имеет пароля. Вы уверены, что хотите сгенерировать новый пароль? Он будет отправлен по адресу: ' . $__templater->escape($__vars['xf']['visitor']['email']) . '.' . '
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
