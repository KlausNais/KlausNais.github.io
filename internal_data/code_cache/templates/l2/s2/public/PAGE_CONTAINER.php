<?php
// FROM HASH: 258e805ea24e213e62fbb20e1079c364
return array(
...
<link href = "styles/alt/fonts/stylesheet.css" rel = "stylesheet" type = "text/css" />
...
';
	...
	if (strlen(trim($__compilerTemp2)) > 0) {
		$__compilerTemp1 .= '
					<a class="p-staffBar-link menuTrigger" data-xf-click="menu" data-xf-key="alt+m" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Модер.' . '</a>
		...
		if ($__vars['xf']['options']['enableTagging']) {
			$__compilerTemp8 .= '
													<span tabindex="0" role="button"
														data-xf-init="tooltip" data-trigger="hover focus click" title="' . $__templater->filter('Также будет выполнен поиск по тегам', array(array('for_attr', array()),), true) . '">
			...
			<template class="js-installTemplateIOS">
				...
				<div class="block-body">
					<div class="block-row">
						...
						<p>
							<small><strong>' . 'Примечание' . $__vars['xf']['language']['label_separator'] . '</strong> ' . 'this_feature_currently_may_not_be_available_in_some_browsers' . '</small>
						</p>
					</div>
				</div>
			</template>
...
<div class="p-body">
	...
	$__finalCompiled .= '
		...
		';
	if ($__templater->func('property', array('dt_latest_posts', ), false)) {
		$__finalCompiled .= '
...
<footer class="p-footer" id="footer">
	...
	if ($__templater->func('property', array('mdm_footer', ), false)) {
		$__finalCompiled .= $__templater->includeTemplate('mdm_footer', $__vars);
	}
	$__finalCompiled .= '
	...
	if ($__templater->method($__vars['xf']['cookieConsent'], 'getMode', array()) == 'advanced') {
		$__compilerTemp13 .= '
							<li><a href="' . $__templater->func('link', array('misc/cookies', ), true) . '" rel="nofollow"
								data-xf-init="tooltip" title="' . $__templater->filter('Согласие на использование файлов cookie', array(array('for_attr', array()),), true) . '"
	...
	if (strlen(trim($__compilerTemp14)) > 0) {
		...
		if (!$__templater->func('property', array('dt_removecopy', ), false)) {
			$__finalCompiled .= '
					<br />
					Theming with ' . $__templater->fontAwesome('fa-heart', array(
			)) . ' by: <a href="http://www.dohtheme.com">DohTheme</a>
				';
		}
		$__finalCompiled .= '
			</div>
...
<div class="u-navButtons js-navButtons" data-trigger-type="' . $__templater->func('property', array('scrollJumpButtons', ), true) . '">
	...
	)) . '<span class="u-srOnly">' . 'Назад' . '</span>', array(
		'href' => 'javascript:',
		'class' => 'button--scroll',
	), '', array(
	)) . '
