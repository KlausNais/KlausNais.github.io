...
<div class="block block--messages">
	...
	$__finalCompiled .= '
		...
		'data-sk-unstar' => 'Снять пометку',
				...
				' . $__templater->button('
					' . ($__vars['userConv']['is_unread'] ? 'Отметить прочитанным(и)' : 'Отметить непрочитанным(и)') . '
				', array(
		'href' => $__templater->func('link', array('conversations/mark-unread', $__vars['conversation'], ), false),
		'class' => 'button--link',
		'data-xf-click' => 'switch',
		'data-sk-read' => 'Отметить прочитанным(и)',
		'data-sk-unread' => 'Отметить непрочитанным(и)',
	), '', array(
	)) . '
				' . $__templater->button('
					' . 'Покинуть' . '
		...
		<div class="block-outer block-outer--after">
			<dl class="blockStatus">
				...
				<dd class="blockStatus-message blockStatus-message--locked">
					' . 'Эта переписка закрыта от размещения в ней новых ответов.' . '
				</dd>
			</dl>
		</div>
	';
