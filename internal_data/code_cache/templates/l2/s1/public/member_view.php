...
<ul class="tabPanes js-memberTabPanes">
	...
	if ($__templater->method($__vars['user'], 'canViewPostsOnProfile', array())) {
		...
		if (!$__templater->test($__vars['profilePosts'], 'empty', array())) {
			...
			$__finalCompiled .= '
							<div class="block-row js-replyNoMessages">' . 'В профиле пользователя ' . $__templater->escape($__vars['user']['username']) . ' пока нет ни одного сообщения.' . '</div>
						';
		}
		$__finalCompiled .= '
					</div>
