	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				' . 'Вы уверены, что хотите повторно отправить электронное письмо о сбросе блокировки безопасности? Любые предыдущие электронные письма сброса блокировки безопасности больше не будут работать. Это письмо будет отправлено на ' . $__templater->escape($__vars['xf']['visitor']['email']) . '.' . '
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
